    ...
    for feature in r:
        if feature['appId'] == 6245718179446784:
            ...
            if group_name.startswith('_'):
                if created_by not in ['ihands@redhat.com', 'rlong@redhat.com', 'mmenestr@redhat.com']:
                    if last_updated_by not in ['ihands@redhat.com', 'rlong@redhat.com', 'mmenestr@redhat.com']:
